...
const APP_VERSION = "Rev 1.36.2.28 - Role Visibility Toggle";
const REVISION_NOTE =
  "Added an optional role visibility toggle for testing company-level record visibility by assigned salesperson or sales manager.";
