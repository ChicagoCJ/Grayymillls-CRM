...
const APP_VERSION = "Rev 1.36.2.19 - Company Detail Sales Coverage Scope Fix";
const REVISION_NOTE =
  "Company detail sales coverage permissions now resolve correctly from Home into the detail panel.";
