...
const APP_VERSION = "Rev 1.36.2.41 - Funnel Display Role Filter";
const REVISION_NOTE =
  "Role visibility is now applied directly to the Funnel opportunity display list for Sales Rep testing.";
