...
const APP_VERSION = "Rev 1.36.2.14 - Sales Coverage Permission Control";
const REVISION_NOTE =
  "Sales Reps can view company sales coverage, while Admins and Sales Managers can edit salesperson and manager assignments.";
