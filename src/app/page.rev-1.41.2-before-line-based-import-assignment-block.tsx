...
const APP_VERSION = "Rev 1.41.1 - Visible Import Assignment Block";
const REVISION_NOTE =
  "Import ZoomInfo now shows an assignment block for applying Salesperson and Sales Manager coverage during import.";
