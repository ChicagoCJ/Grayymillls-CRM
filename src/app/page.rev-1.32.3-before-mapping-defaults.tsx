...
const APP_VERSION = "Rev 1.32.2 - Exact ZoomInfo Industry Mapping";
const REVISION_NOTE =
  "ZoomInfo import now reads SIC Code 1, SIC Codes, NAICS Code 1, NAICS Codes, Primary Industry, and Primary Sub-Industry by exact header name.";
