...
const APP_VERSION = "Rev 1.36.2.3 - Inline Visible Tabs Fix";
const REVISION_NOTE =
  "Role Testing Mode now filters navigation tabs inline so restricted tabs hide without missing state errors.";
