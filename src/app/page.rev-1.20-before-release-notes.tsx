        ...
        {activeTab === "dashboard" && (
          <section className="grid gap-6">
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm">
              <h2 className="text-xl font-bold">Rev 1.19 Objective</h2>
                <p className="mt-3 max-w-4xl text-sm leading-6 text-slate-600">
                This revision completes the first pass of Market, Sector, and Category segmentation by allowing companies and contacts to be tagged and filtered from the CRM list views.
                </p>
