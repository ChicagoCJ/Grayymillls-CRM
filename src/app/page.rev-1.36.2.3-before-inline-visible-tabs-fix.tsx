...
const APP_VERSION = "Rev 1.36.2.2 - Inline Role Change Fix";
const REVISION_NOTE =
  "Role Testing Mode now changes roles with an inline handler and safely redirects from restricted tabs.";
