...
const APP_VERSION = "Rev 1.36.2.39 - Funnel Role Visibility";
const REVISION_NOTE =
  "Apply Role Visibility now filters funnel opportunities for Sales Reps based on related company salesperson assignment.";
