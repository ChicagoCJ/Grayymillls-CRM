...
const APP_VERSION = "Rev 1.41.12 - Import Assignment Cleanup";
const REVISION_NOTE =
  "Import Sales Coverage Assignment now includes a Clear Assignment button while retaining selections across repeated imports.";
