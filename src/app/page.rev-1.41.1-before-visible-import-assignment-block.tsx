...
const APP_VERSION = "Rev 1.41 - Import Assignment Block";
const REVISION_NOTE =
  "ZoomInfo imports can now assign imported company records to a Salesperson / Rep and Sales Manager during import.";
