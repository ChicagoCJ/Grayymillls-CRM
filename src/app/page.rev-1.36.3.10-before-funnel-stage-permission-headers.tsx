...
const APP_VERSION = "Rev 1.36.3.9 - Hard Funnel Stage Permission Enforcement";
const REVISION_NOTE =
  "Funnel stage definition changes are now blocked at the API level for Sales Manager and Sales Rep users.";
