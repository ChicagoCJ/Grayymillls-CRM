...
const APP_VERSION = "Rev 1.36.2.1 - Role Change Handler Fix";
const REVISION_NOTE =
  "Role Testing Mode now has a defined role-change handler and safely redirects from restricted tabs.";
