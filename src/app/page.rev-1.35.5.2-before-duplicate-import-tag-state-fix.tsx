...
const APP_VERSION = "Rev 1.35.5.1 - Import Tag Persistence Fix";
const REVISION_NOTE =
  "Selected import tags are now applied to created or reused companies and contacts during CSV import.";
