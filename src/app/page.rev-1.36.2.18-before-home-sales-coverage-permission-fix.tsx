...
const APP_VERSION = "Rev 1.36.2.17 - Force Company Detail Permission Prop";
const REVISION_NOTE =
  "Company detail now safely receives and defaults the sales coverage edit permission.";
