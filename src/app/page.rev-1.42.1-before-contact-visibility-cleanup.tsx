...
const APP_VERSION = "Rev 1.42 - Contact Visibility Inherits Company Assignment";
const REVISION_NOTE =
  "Contacts now inherit role visibility from their related company assignment, keeping sales coverage at the company level.";
