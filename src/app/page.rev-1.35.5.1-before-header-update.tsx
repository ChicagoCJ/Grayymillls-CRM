...
const APP_VERSION = "Rev 1.35.5 - Import Tag Persistence Fix";
const REVISION_NOTE =
  "Selected import Markets, Sectors, and Categories are now sent with the CSV import and applied to created or reused CRM records.";
