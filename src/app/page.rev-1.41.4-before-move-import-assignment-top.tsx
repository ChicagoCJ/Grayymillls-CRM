...
const APP_VERSION = "Rev 1.41.3 - Import Assignment Heading Fix";
const REVISION_NOTE =
  "Assign Imported Records now inserts based on the actual Import UI heading, not the revision note.";
              ...
              <>
                ...
                <div className="rounded-2xl bg-white p-6 shadow-sm">
                  <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                    <div>
                      <h3 className="text-lg font-bold">Assign Imported Records</h3>
                      <p className="mt-2 text-sm leading-6 text-slate-600">
                        Assign every company created or reused from this ZoomInfo import to a Salesperson / Rep and Sales Manager.
                      </p>
                    </div>
                  </div>
                  ...
                  {(importAssignedSalespersonId || importAssignedSalesManagerId) && (
                    <p className="mt-4 rounded-xl border border-blue-200 bg-blue-50 p-3 text-sm font-semibold text-blue-900">
    ...
    <section className="rounded-2xl bg-white p-6 shadow-sm">
      ...
      {roleVisibilityActive && (
        <div className="mt-6 rounded-2xl border border-blue-200 bg-blue-50 p-4 text-sm text-blue-900">
          ...
          <p className="mt-1">
            Current user: <span className="font-semibold">{currentUserDisplayName}</span> · Role:{" "}
            <span className="font-semibold">{formatAppUserRole(currentUserRole)}</span> · Coverage:{" "}
