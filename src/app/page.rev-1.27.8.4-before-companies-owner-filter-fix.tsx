...
const APP_VERSION = "Rev 1.27.8.3 - Owner Filter Insert Fix";
const REVISION_NOTE =
  "Assigned Owner now appears inside the Companies filter block with Priority, Status, and Product Path.";
