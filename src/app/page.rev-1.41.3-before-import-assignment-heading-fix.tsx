...
const APP_VERSION = "Rev 1.41.2 - Import Assignment Block Placement";
const REVISION_NOTE =
  "Assign Imported Records is now placed directly in the ZoomInfo Import workflow and included in the import payload.";
