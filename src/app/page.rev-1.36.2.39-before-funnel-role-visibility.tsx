...
const APP_VERSION = "Rev 1.36.2.38 - Assignment-Aware Opportunity GET";
const REVISION_NOTE =
  "Sales opportunities now use an assignment-aware GET response for funnel role visibility testing.";
