...
const APP_VERSION = "Rev 1.36.2.5 - Navigation Stabilization Fix";
const REVISION_NOTE =
  "Role Testing Mode remains available while navigation tab filtering is temporarily stabilized.";
