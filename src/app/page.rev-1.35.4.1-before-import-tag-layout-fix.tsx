...
const APP_VERSION = "Rev 1.35.3 - Import Tag Panel Reset Fix";
const REVISION_NOTE =
  "The import tag assignment panel now resets and reloads Markets, Sectors, and Categories after CSV upload/import cycles.";
