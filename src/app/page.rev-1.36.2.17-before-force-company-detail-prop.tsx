...
const APP_VERSION = "Rev 1.36.2.16 - Sales Coverage Prop Definition Fix";
const REVISION_NOTE =
  "Company detail now defines the sales coverage edit permission prop used by the Sales Coverage panel.";
