...
const APP_VERSION = "Rev 1.32.1 - ZoomInfo Industry Fallback";
const REVISION_NOTE =
  "ZoomInfo imports now use AM/AP/AS/AT positional fallback for SIC, NAICS, Primary Industry, and Primary Sub-Industry.";
