...
const APP_VERSION = "Rev 1.15.3 - Explicit AI Analysis Flag";
const REVISION_NOTE =
  "AI intelligence sections now display only when the record was generated by the Analyze Prospect workflow.";
