...
const APP_VERSION = "Rev 1.36.2.11 - Safe Role-Based Tab Hiding";
const REVISION_NOTE =
  "Role Testing Mode now hides Admin and Import navigation tabs using direct inline role checks.";
