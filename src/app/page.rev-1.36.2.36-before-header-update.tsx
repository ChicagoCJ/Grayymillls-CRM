...
const APP_VERSION = "Rev 1.36.2.35 - Funnel Visibility Fields";
const REVISION_NOTE =
  "Sales opportunity API now returns related company salesperson and sales manager assignments for future funnel role visibility.";
